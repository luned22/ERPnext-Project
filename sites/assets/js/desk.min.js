...
/*
 *	/home/guest/frappe-bench/apps/frappe/frappe/public/js/lib/jquery/jquery-ui.min.js
 */
...
/*
 *	/home/guest/frappe-bench/apps/frappe/frappe/public/js/lib/Sortable.min.js
 */
...
/*
 *	/home/guest/frappe-bench/apps/frappe/frappe/public/js/lib/tag-it.min.js
 */
...
/*
 *	/home/guest/frappe-bench/apps/frappe/frappe/public/js/lib/bootstrap.min.js
 */
/*!
...
return NProgress;});;
/*
 *	/home/guest/frappe-bench/apps/frappe/frappe/public/js/lib/moment/moment-with-locales.min.js
 */
...
/*
 *	/home/guest/frappe-bench/apps/frappe/frappe/public/js/lib/moment/moment-timezone-with-data.min.js
 */
//! moment-timezone.js
//! version : 0.3.1
//! author : Tim Wood
...
/*
 *	/home/guest/frappe-bench/apps/frappe/frappe/public/js/lib/socket.io.min.js
 */
...
return;}
var dataurl=null;var _upload_file=function(){if(opts.on_attach){opts.on_attach(args,dataurl)}else{var msgbox=msgprint(__("Uploading..."));if(opts.start){opts.start();}
return frappe.call({"method":"uploadfile",args:args,callback:function(r){if(!r._server_messages)
msgbox.hide();if(r.exc){opts.onerror?opts.onerror(r):opts.callback(null,null,r);return;}
var attachment=r.message;opts.callback(attachment,r);$(document).trigger("upload_complete",attachment);},progress:function(data){if(opts.progress){opts.progress(data);}},always:function(data){if(opts.always){opts.always(data);}},error:function(r){opts.onerror?opts.onerror(r):opts.callback(null,null,r);return;},btn:opts.btn});}}
